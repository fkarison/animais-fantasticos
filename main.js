...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (/* binding */ initScroll)\n/* harmony export */ });\nfunction initScroll() {\n  var sections = document.querySelectorAll(\"[data-anime='scroll']\"); // retorna as sections com a classe .js-scroll\n\n  var windowsCorte = window.innerHeight * 0.65; // define que o topo da página será 65% do tamanho da tela\n\n  function animaScroll() {\n    sections.forEach(function (section) {\n      var sectionTop = section.getBoundingClientRect().top; // retorna a altura que cada section está em relação ao topo\n\n      var isSectionVisible = sectionTop - windowsCorte < 0; // se a altura da section em relação ao topo - 65% da tela for menor que 0 retorne verdadeiro\n\n      if (isSectionVisible) {\n        section.classList.add('ativo');\n      } else if (section.classList.contains('ativo')) {\n        section.classList.remove('ativo');\n      }\n    });\n  } // IF abaixo verifica se sections existe para executar o restante do código\n\n\n  if (sections.length) {\n    animaScroll();\n    window.addEventListener('scroll', animaScroll);\n  }\n}\n\n//# sourceURL=webpack://animais-fantasticos/./js/modules/scroll-animacao.js?");
